...
class _SinglePostSheetState extends State<SinglePostSheet> {
  ...
  bool _canDeleteComment(PostComment comment) {
    if (widget.currentUserId == null || comment.creatorUserSubId == null)
      return false;
    return widget.currentUserId == comment.creatorUserSubId;
  }
  ...
  Future<void> _connectToSignalR() async {
    ...
    const token =
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9._ZiSDYudmE2Ykg2KfZhNi02YrZiNmJIiwiZW1haWwiOiIxNDU0MUBzYWJyb2FkLm1vZS5lZHUuZWciLCJwaG9uZV9udW1iZXIiOiIiLCJwcm9maWxlX3BpY3R1cmVfdXJsIjoiIiwic3RhZ2VfbmFtZSI6Itin2YTYqti52YTZitmFINin2YTYp9i52K_Yp9iv2YogIiwiZ3JhZGVfbmFtZSI6Itin2YTYtdmBINin2YTYq9in2YbZiiDYp9mE2KfYudiv2KfYr9mKIiwiY291bnRyeV9uYW1lIjoi2KXZiti32KfZhNmK2KciLCJuYmYiOjE3NzE4NDc3NzgsImV4cCI6MTc3MjE5MzM3OCwiaWF0IjoxNzcxODQ3Nzc4fQ.lKT3WL51EjK_jnrW1-NHAB2El6ENtgwU4dyH8jglbmA';
